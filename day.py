...
def hero():
    ...
    while(y):
        clear()
        system(banner)
        print("THANK YOU FOR BUYING 1 DAY HACK")
...
if(expirydate>today):
    ...
    while(True):
        print("My banking Telegram name is @RXCE_HACKING")
        print("If you send to any other name , then IT IS SCAMMM")
        print("--------*--------*----------*---------")
        print("send payment only to @RXCE_HACKING ")
        ...
        if(bhai==code or bhai==test):
            ...
            print("Please play on the given time, and ")
            print("If you think it is an error contact")
            print("me on telegram @RXCE_HACKING")
            print("wait.... starting....")
            time.sleep(20)
            period=rava
            #hero()
